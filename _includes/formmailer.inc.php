...
#			$strEmpfaenger = "kontakt@muenchen-alexander-technik.de";
			$strEmpfaenger = 'info@qf-alexander-technik.de, aj.rohac@googlemail.com, info@alexander-technik-thuernagel.de, alexandertechnik@andreasdirscherl.de, ausbildung@fmat.de, jutta-hillebrand@web.de, m.schultka@googlemail.com';
	}  #  END switch  
} # END if
...
// Testempf�nger
// $strEmpfaenger = "andreas.dirscherl@googlemail.com"; 

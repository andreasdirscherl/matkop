	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		function _showContent(){
			...
			$pp_pic_holder.animate({
				'top': projectedTop - 130,
				'left': (windowWidth/2) - (pp_dimensions['containerWidth']/2) - 90,
		...
		*/
		function _getDimensions(width,height){
			...
			pp_contentHeight = height; // + detailsHeight; AD: Remove Details
		...
		function _center_overlay(){
			if(doresize && typeof $pp_pic_holder != 'undefined') {
				...
				$pp_pic_holder.css({
					'top': projectedTop - 130,
					'left': (windowWidth/2) + scroll_pos['scrollLeft'] - (contentwidth/2) - 90
				});
			};
		};
